...
AMAL_H = os.path.join(AMALGAMATE_OUTPUT_PATH, OUTPUT_H)
AMAL_C = os.path.join(AMALGAMATE_OUTPUT_PATH, OUTPUT_CPP)
...
print(f'#include "{OUTPUT_H}"', file=amal_c)
print("", file=amal_c)
for c in ALLCFILES:
