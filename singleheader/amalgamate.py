    ...
    with open(file, 'r') as fid2:
        for line in fid2:
            ...
            if s:
                ...
                # we explicitly include lexer headers, one time each
...
AMAL_H = os.path.join(AMALGAMATE_OUTPUT_PATH, "lexer.h")
AMAL_C = os.path.join(AMALGAMATE_OUTPUT_PATH, "lexer.cpp")
...
zf.write(os.path.join(AMALGAMATE_OUTPUT_PATH,"lexer.cpp"), "lexer.cpp")
zf.write(os.path.join(AMALGAMATE_OUTPUT_PATH,"lexer.h"), "lexer.h")
